...
public class WJContext implements AbsListView.MultiChoiceModeListener, DialogInterface.OnClickListener {
    ...
    WJContext(Workout activity, WorkoutDataAdapter.Subject subj)
    {
        super();
    ...
    public void onDeleteLogEntriesPressed() {
        ...
        if ( contextSubj  == WorkoutDataAdapter.Subject.EXERCISES ) {
            ...
            if (affectedExEntries > 0)
                activity.initiateListUpdate(WorkoutDataAdapter.Subject.EXERCISES, Workout.TriggerEvent.DELETE);
            ...
            if (affectedSetEntries != 0) {
                ...
                activity.initiateListUpdate(WorkoutDataAdapter.Subject.SETS, Workout.TriggerEvent.DELETE);
            }
    ...
    public void onAddEditedBtnPressed() {
        ...
        if ( !haveError ) {
            ...
            if ( !haveError ) {
                activity.initiateListUpdate( contextSubj, Workout.TriggerEvent.EDIT ); //TODO: need other, separate event?
