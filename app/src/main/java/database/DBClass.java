...
public class DBClass {
    ...
    public static final  String APP_NAME = "ProjectApp";

    public static final String DB_NAME = "ProjectApp";
    ...
    */
    ...
    private class DBHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            if ( DEBUG_FLAG ) Log.v(APP_NAME, "DBClass :: onCreate :: exercises log table created");
        }
