...
/**
 * Created by v-dafran on 11/03/2016.
 */
public class ProAppSettingsFragment extends PreferenceFragment implements Preference.OnPreferenceClickListener {
    ...
    public boolean copyFile( String from, String to ) {
        if ( DEBUG_FLAG ) Log.v(APP_NAME, "ProAppSettingsFragment :: copyFile");
    ...
    public boolean copyDB( boolean isRestore, String pathArg ) {
        if ( DEBUG_FLAG ) Log.v(APP_NAME, "ProAppSettingsFragment :: copyDB" );
        //find own DB
        String inAppDbDir = "/data/data/WorkoutAdapters/databases/";
        ...
        if ( inAppDbPath.isEmpty() ) {
            Log.e(APP_NAME,"ProAppSettingsFragment :: copyDB :: failed to find own DB file location.");
            return false;
        }
        ...
        {
            Log.e(APP_NAME,"ProAppSettingsFragment :: copyDB :: provided file path is a directory.");
            return false;
        }
        ...
        if ( !passedFile.exists() )
        {
            ...
            if ( isRestore )
            {
                Log.e(APP_NAME,"ProAppSettingsFragment :: copyDB :: source file not found.");
                return false;
            }
            else
            {
                ...
                {
                    Log.e(APP_NAME,"ProAppSettingsFragment :: copyDB :: failed to create file.");
                    return false;
                }
            }
        }
    ...
    public boolean contactDev() {
        if ( DEBUG_FLAG ) Log.v(APP_NAME, "ProAppSettingsFragment :: contactDev" );
        Intent emailIntent = new Intent(Intent.ACTION_SEND);

        emailIntent.setType("message/rfc822");
        emailIntent.putExtra(Intent.EXTRA_EMAIL, new String[] {"davidfranklin1@gmail.com"}); // recipients
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Workout Journal");
    ...
    public boolean onPreferenceClick(Preference pref) {
        if ( DEBUG_FLAG ) Log.v(APP_NAME, "ProAppSettingsFragment :: onPreferenceClick" );
        boolean res = false;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.proappprefs);
    ...
    public Intent createEmailOnlyChooserIntent(Intent source,
        ...
        if ( DEBUG_FLAG ) Log.v(APP_NAME, "ProAppSettingsFragment :: createEmailOnlyChooserIntent" );
